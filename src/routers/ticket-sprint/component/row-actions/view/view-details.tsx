...
import { TicketSprintDetail } from '../../../interface';
import { Printer } from 'lucide-react';

export const TicketSprintViewDetails = ({ data }: { data?: TicketSprintDetail }) => {
    ...
    <>
      {data && (
        <div className="flex flex-col h-full">
          ...
          <span className="font-medium text-sm">Ticket Sprint Id</span>
