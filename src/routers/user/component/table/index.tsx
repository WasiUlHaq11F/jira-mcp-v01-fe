...
const UserCreate = lazy(() => import('../header-actions/create'));
const UserUpdate = lazy(() => import('../row-actions/update'));
const UserDelete = lazy(() => import('../row-actions/delete'));
const UserView = lazy(() => import('../row-actions/view'));

export const UserTable: React.FC = memo(() => {
  ...
  const columns = useMemo(() => userGetColumns(multiSortEnabled), [multiSortEnabled]);
  ...
  const {
    ...
    queryKey: [USER_CONSTANTS.QUERY_KEY],
    fetchFn: getUsers,
    defaultPageSize: -1,
    filterParsers: {
